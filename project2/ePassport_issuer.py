...
with open('schemas/ePassport_VC_Schema_V1.0.json', 'r') as schema_file:
    vc_schema = json.load(schema_file)

with open('schemas/ePassport_VC_Content_Schema_V1.0.jsonld.json', 'r') as content_schema_file:
...
with open('keys/ePassport_private_key.pem', 'wb') as f:
...
with open('keys/ePassport_public_key.pem', 'wb') as f:
...
def create_ePassport_vc():
    ...
    claims = {
        ...
        "issuerCode": "A1234567",
        "natlText": "USA",
        "passportNumberIdentifier": "1234567"
    }
...
if __name__ == "__main__":
    vc, claims = create_ePassport_vc()  # Generate VC with _sd array
