...
with open('schemas/Visa_VC_Schema_V1.0.json', 'r') as schema_file:
    vc_schema = json.load(schema_file)

with open('schemas/Visa_VC _Content _Schema_V1.0.jsonld.json', 'r') as content_schema_file:
...
with open('keys/Visa_private_key.pem', 'wb') as f:
...
with open('keys/Visa_public_key.pem', 'wb') as f:
...
if __name__ == "__main__":
    vc, claims = create_Visa_vc()  # Generate VC with _sd array
